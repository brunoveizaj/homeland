...
public class MerrPasuriPronaretPropertyModel implements Serializable {
	...
	@JsonProperty("Adresa")
	private MerrPasuriPropertyAddressModel address;
	...
	public MerrPasuriPropertyAddressModel getAddress() {
		return address;
	}
	public void setAddress(MerrPasuriPropertyAddressModel address) {
